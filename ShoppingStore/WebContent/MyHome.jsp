		...
		<div class="container-fluid" id="head-top">
			<div id="head-top-content">
				...
				<div id="head-top-content-center">
					欢迎光临当当，<span id="uname">${sessionScope.username}</span><a href="login.jsp">[退出]</a>
				</div>
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="person.do">个人信息</a></li>
								<li><a href="cart.do">购物车</a></li>
								<li><a href="#">积分抵现</a></li>
								<li><a href="#">我的收藏</a></li>
								<li><a href="MyDangDang_balance.jsp">我的余额</a></li>
							</ul>
						</li>
						<li><button class="btn">
